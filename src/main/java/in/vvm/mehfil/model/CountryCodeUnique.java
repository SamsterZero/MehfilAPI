...
import in.vvm.mehfil.service.CountryService;
...
public @interface CountryCodeUnique {
    ...
    class CountryCodeUniqueValidator implements ConstraintValidator<CountryCodeUnique, Integer> {
        ...
        public boolean isValid(final Integer value, final ConstraintValidatorContext cvContext) {
            ...
            if (currentId != null && value.equals(countryService.get(Long.parseLong(currentId)).getCode())) {
